...
for framework in frameworkPlot:
    ...
    successRate = 0
    for nameDS in XPS:
        successRate += dfSI._get_value(framework, nameDS)       
    successRate /= 6
    dataTable[framework]["Scenario I"] = successRate
     
    successRate = 0
    for nameDS in XPS:
        successRate += dfSII._get_value(framework, nameDS)           
    successRate /= 6
    dataTable[framework]["Scenario II"] = successRate

    successRate = 0
    for nameDS in XPS:
        successRate += dfSIII._get_value(framework, nameDS)       
    successRate /= 6
    dataTable[framework]["Scenario III"] = successRate

   
    averageSR = (dataTable[framework]["Scenario I"] + dataTable[framework]["Scenario II"] +dataTable[framework]["Scenario III"])/3
    dataTable[framework]["Average"] = "{0:.2f}".format(averageSR)
    dataTable[framework]["Scenario I"] = "{0:.2f}".format(dataTable[framework]["Scenario I"])
    dataTable[framework]["Scenario II"] = "{0:.2f}".format(dataTable[framework]["Scenario II"])
    dataTable[framework]["Scenario III"] = "{0:.2f}".format(dataTable[framework]["Scenario III"])
